  ...
  return (
    <div className="w-full">
      <div className="container mx-auto max-w-7xl bg-black rounded-xl text-white my-20 py-4">
        ...
        <div className="flex flex-col md:flex-row px-8 justify-center items-center my-8">
          <div className="w-full md:w-[70%] py-6 md:py-0">
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  ...
                  costlier and more challenging to manage. A senior designer
                  might set you back $100k+, while a developer could easily
                  exceed $300k. That&apos;s a total of $500k+ when you factor in
          ...
          <div className="w-full md:w-[30%] flex-col justify-center items-center md:px-24">
